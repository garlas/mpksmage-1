...
<section id="content">
    <div class="container content">
        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="artikel-utama">
                    ...
                    <div class="artikel-sampul" style="text-align: center;">
                        <img src="images/posting/<?php echo $a['posting_sampul']; ?>" alt="Sampul Artikel" style="width: 100%; max-height: 400px; object-fit: cover; border-radius: 12px; margin-bottom: 20px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
                    </div>

                    <!-- Judul Artikel -->
                    <h1 class="artikel-judul" style="font-size: 28px; font-weight: bold; margin-bottom: 10px; color: #333;">
                    ...
                    <!-- Konten Artikel -->
                    <div class="artikel-konten" style="font-size: 16px; line-height: 1.8; color: #444;">
            ...
            <!-- Artikel Lainnya -->
            <div class="col-md-4">
                <div class="artikel-lainnya" style="padding: 20px; background: #f9f9f9; border-radius: 12px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
                    ...
                    <ul style="list-style-type: none; padding: 0;">
                        ...
                        <li style="margin-bottom: 15px; border-bottom: 1px solid #eee; padding-bottom: 10px;">
                            <a href="single.php?id=<?php echo $xx['posting_id']; ?>" style="font-size: 14pt; font-weight: 600; text-decoration: none; color: #007bff;">
