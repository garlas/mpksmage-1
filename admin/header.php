...
<head>
	...
	<title>Super Admin - Sistem Aspirasi SMAN 1 GEDEG</title>
		...
		<div class="navbar-collapse collapse" id="navbar-second-toggle">
			<ul class="nav navbar-nav">
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu width-200">
						<li><a href="data_siswa.php"><span><i class="icon-user"></i> &nbsp; Data Siswa</span></a></li>					
						<li><a href="petugas.php"><span><i class="icon-user-tie"></i> &nbsp; Data Petugas</span></a></li>						
						<li><a href="pengaduan.php"><span><i class="icon-file-empty"></i> &nbsp; Aspirasi Siswa</span></a></li>
					</ul>
				</li>				
			</ul>
